...
public enum SellerErrorCode implements ErrorCode {
  ...
  CANNOT_UPDATE_SETTLEMENT_BEFORE_APPROVAL(HttpStatus.UNPROCESSABLE_ENTITY.value(), "CANNOT_UPDATE_SETTLEMENT_BEFORE_APPROVAL"),
  CANNOT_WITHDRAW_WITH_ACTIVE_PRODUCTS(HttpStatus.UNPROCESSABLE_ENTITY.value(), "CANNOT_WITHDRAW_WITH_ACTIVE_PRODUCTS"),
  CANNOT_REGISTER_PERFORMANCE(HttpStatus.UNPROCESSABLE_ENTITY.value(), "CANNOT_REGISTER_PERFORMANCE");
